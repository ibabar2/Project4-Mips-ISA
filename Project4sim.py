...
def simulator(ImemArray):
    ...
    while MachineCodeInHex != "0x1000FFFF" or MachineCodeInHex != "0x1000ffff":
        ...
        print("The  Current INSTRUCTION is:", MachineCodeInHex)
        print("One Previous INSTRUCTION was:", MachineCodeInHex_old)
    ...
    print("Single Cycle Details are as follows:")
    print("DIC Count is:   ", dic)
    print("\n")

    print("MultiCycle Details are as follows:")
    print("The amount of 3 cycle instructions were ", three_cycles)
    print("The amount of 4 cycle instructions were  ", four_cycles)
    print("The amount of 5 cycle instructions were", five_cycles)
    print(" The total number of cycles are:      ", multi_cyclesCounter)
    print("\n")

    delay_hazards = pipe_delays[0]
    ctrl_hazards = pipe_delays[1]
    p_cycles = dic + 4 + delay_hazards + ctrl_hazards
    print("PIPELINED DETAILS:")
    print("Amount of Data Hazard Delays: ", delay_hazards)
    print("Amount of Control Hazard Delays: ", ctrl_hazards)
